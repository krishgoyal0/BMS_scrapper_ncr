...
def extract_event_details(image_path):
    try:
        ...
        # Get current timestamp for when data is extracted
        ...
        details = {
            ...
            'price': None,
            'seats_status': None,
            'date_added': current_time.strftime("%Y-%m-%d"),  # Date in YYYY-MM-DD format
            'time_added': current_time.strftime("%H:%M:%S")   # Time in HH:MM:SS format
        }
